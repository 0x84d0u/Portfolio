...
export type WorkMinAggregateOutputType = {
  ...
  address: string | null
  location: $Enums.WorkLocation | null
  contract: $Enums.WorkContract | null
  createdAt: Date | null
  updatedAt: Date | null
}
...
export type WorkGroupByOutputType = {
  ...
  organisation: string
  address: string
  location: $Enums.WorkLocation
  contract: $Enums.WorkContract
  createdAt: Date
  updatedAt: Date
  _count: WorkCountAggregateOutputType | null
  _min: WorkMinAggregateOutputType | null
...
export type WorkWhereInput = {
  ...
  roles?: Prisma.StringNullableListFilter<"Work">
  period?: Prisma.StringFilter<"Work"> | string
  organisation?: Prisma.StringFilter<"Work"> | string
  address?: Prisma.StringFilter<"Work"> | string
  location?: Prisma.EnumWorkLocationFilter<"Work"> | $Enums.WorkLocation
  contract?: Prisma.EnumWorkContractFilter<"Work"> | $Enums.WorkContract
...
export type WorkScalarWhereWithAggregatesInput = {
  ...
  roles?: Prisma.StringNullableListFilter<"Work">
  period?: Prisma.StringWithAggregatesFilter<"Work"> | string
  organisation?: Prisma.StringWithAggregatesFilter<"Work"> | string
  address?: Prisma.StringWithAggregatesFilter<"Work"> | string
  location?: Prisma.EnumWorkLocationWithAggregatesFilter<"Work"> | $Enums.WorkLocation
  contract?: Prisma.EnumWorkContractWithAggregatesFilter<"Work"> | $Enums.WorkContract
...
export type WorkCreateInput = {
  ...
  title: string
  description: string
  roles?: Prisma.WorkCreaterolesInput | string[]
  period: string
  organisation: string
  address: string
  location: $Enums.WorkLocation
...
export type WorkUpdateInput = {
  ...
  roles?: Prisma.WorkUpdaterolesInput | string[]
  ...
  location?: Prisma.EnumWorkLocationFieldUpdateOperationsInput | $Enums.WorkLocation
  contract?: Prisma.EnumWorkContractFieldUpdateOperationsInput | $Enums.WorkContract
...
export type WorkCreaterolesInput = {
  set: string[]
}

export type WorkUpdaterolesInput = {
  set?: string[]
  push?: string | string[]
}
...
export type EnumWorkContractFieldUpdateOperationsInput = {
  set?: $Enums.WorkContract
}
...
export type WorkOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "roles" | "period" | "organisation" | "address" | "location" | "contract" | "createdAt" | "updatedAt", ExtArgs["result"]["work"]>
...
export interface WorkFieldRefs {
  ...
  readonly roles: Prisma.FieldRef<"Work", 'String[]'>
  readonly period: Prisma.FieldRef<"Work", 'String'>
  readonly organisation: Prisma.FieldRef<"Work", 'String'>
  readonly address: Prisma.FieldRef<"Work", 'String'>
  readonly location: Prisma.FieldRef<"Work", 'WorkLocation'>
  readonly contract: Prisma.FieldRef<"Work", 'WorkContract'>
